                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            <h2 class="text-white mb-4">About Gospel Event Show 2025</h2>

                            <p class="text-white">Gospel Event Show Live is free CSS template provided by TemplateMo website. This
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-text-wrap">
                            <img src="{{ asset('assets/images/anthony-delanoix-hzgs56Ze49s-unsplash.jpg') }}" class="about-image img-fluid">
                            ...
                            <div class="about-text-info d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="mb-0">your amazing Gospel experience with us</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
          @foreach ($artists as $artist)
            <div class="{{ $artist->size === 'large' ? 'col-lg-7 col-12 mb-4' : 'col-lg-5 col-12 mb-4' }}">
                <div class="artists-thumb">
                    <div class="artists-image-wrap">
                        <img src="{{ asset('assets/images/artists/' . $artist->image) }}" class="artists-image img-fluid">
                    </div>

                    <div class="artists-hover">
                        <p><strong>Name:</strong> {{ $artist->name }}</p>
                        <p><strong>Performance date:</strong> {{ $artist->birthdate ? \Carbon\Carbon::parse($artist->birthdate)->format('M d, Y') : 'N/A' }}</p>
                        <p><strong>Music:</strong> {{ $artist->music }}</p>
                        <hr>
                        <p class="mb-0"><strong>Youtube Channel:</strong>
